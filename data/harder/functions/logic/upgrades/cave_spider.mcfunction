...
execute if score rng hrd_num matches 3 run attribute @s generic.movement_speed base set 0.4
...
execute if score rng hrd_num matches 7 run effect give @s minecraft:strength 1000000 4
execute if score rng hrd_num matches 8 run fill ~ ~ ~ ~ ~ ~ minecraft:cobweb replace #harder:air
execute if score rng hrd_num matches 9 run summon minecraft:cave_spider ~ ~ ~
execute if score rng hrd_num matches 9 run summon minecraft:cave_spider ~ ~ ~
execute if score rng hrd_num matches 9 run summon minecraft:cave_spider ~ ~ ~
execute if score rng hrd_num matches 9 run summon minecraft:cave_spider ~ ~ ~
