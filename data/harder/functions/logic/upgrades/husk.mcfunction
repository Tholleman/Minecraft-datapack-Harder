...
execute if score rng hrd_num matches 7 run data modify entity @s Attributes[{Name:generic.movementSpeed}].Base set value 0.3
execute if score rng hrd_num matches 8 run data modify entity @s Attributes[{Name:generic.followRange}].Base set value 2048
execute if score rng hrd_num matches 0 run summon minecraft:husk ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
execute if score rng hrd_num matches 0 run summon minecraft:husk ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
execute if score rng hrd_num matches 0 run summon minecraft:husk ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
execute if score rng hrd_num matches 0 run summon minecraft:husk ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
execute if score rng hrd_num matches 0 run summon minecraft:husk ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
...
execute if score rng hrd_num matches 2 run data modify entity @s Attributes[{Name:zombie.spawnReinforcements}].Base set value 1
