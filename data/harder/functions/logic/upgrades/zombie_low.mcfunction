...
execute if score rng hrd_num matches 4 run data modify entity @s Attributes[{Name:generic.movementSpeed}].Base set value 0.4
execute if score rng hrd_num matches 5 run data modify entity @s Attributes[{Name:generic.followRange}].Base set value 2048
execute if score rng hrd_num matches 0 run summon minecraft:zombie ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
execute if score rng hrd_num matches 0 run summon minecraft:zombie ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
execute if score rng hrd_num matches 0 run summon minecraft:zombie ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
execute if score rng hrd_num matches 0 run summon minecraft:zombie ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
execute if score rng hrd_num matches 0 run summon minecraft:zombie ~ ~ ~ {Attributes:[{Name:zombie.spawnReinforcements,Base:1}]}
