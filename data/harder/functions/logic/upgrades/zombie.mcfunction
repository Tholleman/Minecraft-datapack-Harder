...
execute if score rng hrd_num matches 10 run data modify entity @s Attributes[{Name:generic.max_health}].Base set value 40
...
execute if score rng hrd_num matches 12 run data modify entity @s Attributes[{Name:generic.movement_speed}].Base set value 0.3
...
execute if score rng hrd_num matches 8 run data modify entity @s Attributes[{Name:zombie.spawn_reinforcements}].Base set value 1
