...
execute if score rng hrd_num matches 1 run attribute @s generic.movement_speed base set 0.35
...
execute if score rng hrd_num matches 4 run summon minecraft:zombie_villager ~ ~ ~ {Attributes:[{Name:zombie.spawn_reinforcements,Base:1}]}
execute if score rng hrd_num matches 4 run summon minecraft:zombie_villager ~ ~ ~ {Attributes:[{Name:zombie.spawn_reinforcements,Base:1}]}
execute if score rng hrd_num matches 4 run summon minecraft:zombie_villager ~ ~ ~ {Attributes:[{Name:zombie.spawn_reinforcements,Base:1}]}
execute if score rng hrd_num matches 4 run summon minecraft:zombie_villager ~ ~ ~ {Attributes:[{Name:zombie.spawn_reinforcements,Base:1}]}
execute if score rng hrd_num matches 4 run summon minecraft:zombie_villager ~ ~ ~ {Attributes:[{Name:zombie.spawn_reinforcements,Base:1}]}