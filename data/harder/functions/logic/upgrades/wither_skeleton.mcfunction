...
execute if score rng hrd_num matches 6 run data modify entity @s Attributes[{Name:generic.max_health}].Base set value 50
execute if score rng hrd_num matches 6 run data modify entity @s Health set value 50
execute if score rng hrd_num matches 7 run data modify entity @s Attributes[{Name:generic.knockback_resistance}].Base set value 0.6
execute if score rng hrd_num matches 8 run data modify entity @s Attributes[{Name:generic.movement_speed}].Base set value 0.3
execute if score rng hrd_num matches 9 run data modify entity @s Attributes[{Name:generic.follow_range}].Base set value 2048
