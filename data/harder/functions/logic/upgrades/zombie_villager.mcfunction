...
execute if score rng hrd_num matches 9 run data modify entity @s Attributes[{Name:generic.maxHealth}].Base set value 40
execute if score rng hrd_num matches 9 run data modify entity @s Health set value 40
execute if score rng hrd_num matches 10 run data modify entity @s Attributes[{Name:generic.knockbackResistance}].Base set value 0.6
execute if score rng hrd_num matches 11 run data modify entity @s Attributes[{Name:generic.movementSpeed}].Base set value 0.3
execute if score rng hrd_num matches 12 run data modify entity @s Attributes[{Name:generic.followRange}].Base set value 2048
...
execute if score rng hrd_num matches 8 run data modify entity @s Attributes[{Name:zombie.spawnReinforcements}].Base set value 0.8
