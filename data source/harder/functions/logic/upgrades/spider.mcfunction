...
/execute if <<step>> 3 run attribute @s generic.movement_speed base set 0.5
...
/execute if <<step>> 7 run effect give @s minecraft:strength 1000000 1
/execute if <<step>> 8 run fill ~ ~ ~ ~ ~ ~ minecraft:cobweb replace #<<ns>>:air
\repeat 4
/execute if <<step>> 9 run summon minecraft:spider ~ ~ ~
